...
const rawData = [
  {
    "id": "009c5703bcc13754e9525de8bd0ef0e4",
    "caller_name": "com.alibaba.service.impl.ProductServiceImpl:updateProductInfo",
    "caller_param": "",
    "mapper_name": "com.alibaba.dao.mapper.ProductInfoPOMapper",
    "mapper_method": "insertSelective",
    "table_name": "taobao_product_info"
  },
  {
    "id": "009c5703bcc13754e9525de8bd0ef0e4",
    "caller_name": "com.alibaba.service.impl.ProductServiceImpl:updateProductInfo",
    "caller_param": "",
    "mapper_name": "com.alibaba.dao.mapper.ProductPricePOMapper",
    "mapper_method": "insertSelective",
    "table_name": "taobao_product_price"
  }
];
...
const initGraph = () => {
  ...
  node.append('text')
    .attr('dx', d => d.id === rawData[0].caller_name ? -12 : 12) // Adjust text position
    .attr('dy', '.35em')
    .attr('text-anchor', d => d.id === rawData[0].caller_name ? 'end' : 'start') // Align text to the end for caller_name
    .text(d => d.id)
